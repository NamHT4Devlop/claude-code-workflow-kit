...
#   The Workflow Kit injects it into /cwk-review, /cwk-build and /cwk-pr.
...
> Fill this in after running `/cwk-scan` to add rules specific to your project.
> `/cwk-build` updates this section from what each task taught it.

<!-- Placeholder — written by /cwk-scan, kept current by /cwk-rescan -->
